...
// creating class with class name fee
public class fee extends Frame { 
    ...
    { 
        ...
        rb1 = new JRadioButton("BACHELOR OF TECHNOLOGY/ B.E."); 
        rb1.setBounds(130, 520, 280, 30); 
  
        rb2 = new JRadioButton("BACHELOR OF PHARMACY/ B PHARMACY"); 
        ...
        String languages[] 
            = { "Courses","CSE", "CSE(CS)", "CSE(AIML)", 
                "CIVIL", "MECH" ,"D.PHARM", "B.PHARM" }; 
        final JComboBox cb 
        ...
        li1.addElement("CSE(CS)(2, 50, 000)"); 
        li1.addElement("CSE(AIML)(2, 50, 000)"); 
        li1.addElement("MECH(2, 50, 000)"); 
        li1.addElement("CIVIL(2, 50, 000)"); 
        li1.addElement("D.PHARM(2, 00, 000)"); 
        li1.addElement("B.PHARM,(2, 00, 000)"); 
